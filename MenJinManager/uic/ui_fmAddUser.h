...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget->setGeometry(QRect(52, 32, 181, 80));
        ...
        m_editCardNum = new QLineEdit(widget);
        ...
        m_editJobNum = new QLineEdit(widget);
        ...
        m_editName = new QLineEdit(widget);
        ...
        m_lbPic = new QLabel(groupBox_3);
        m_lbPic->setObjectName(QString::fromUtf8("m_lbPic"));
        m_lbPic->setGeometry(QRect(32, 10, 101, 111));
